...
for f in [r"R:\studia\Gniadek\zaj1\advanced_techniques\zaj5\tone_440.wav", r"R:\studia\Gniadek\zaj1\advanced_techniques\zaj5\tone_noisy.wav", r"R:\studia\Gniadek\zaj1\advanced_techniques\zaj5\twotones.wav"]:
    fs,x=load(f)
